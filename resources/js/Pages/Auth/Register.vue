...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            <div>
                ...
                <input
                    id="name"
                    type="text"
                    class="w-full glass-input text-slate-800 placeholder-slate-400 text-sm rounded-xl px-4 py-2.5 border border-slate-200 focus:outline-none transition shadow-xs"
            ...
            <button
                ...
                class="w-full mt-3 py-3 px-4 bg-gradient-to-r from-brand-600 via-brand-700 to-brand-800 hover:from-brand-500 hover:to-brand-700 disabled:opacity-50 text-white font-bold text-sm rounded-xl shadow-md shadow-brand-600/25 transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2"
            >
        ...
        <div class="mt-6 text-center text-xs text-slate-500 pt-4 border-t border-slate-200">
